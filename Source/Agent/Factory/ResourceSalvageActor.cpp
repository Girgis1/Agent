...
#include "Factory/ResourceSalvageActor.h"
#include "Components/StaticMeshComponent.h"
#include "Factory/ResourceComponent.h"
#include "UObject/ConstructorHelpers.h"

AResourceSalvageActor::AResourceSalvageActor()
{
	...
	ItemMesh->SetMassOverrideInKg(NAME_None, 10.0f, true);
...
void AResourceSalvageActor::BeginPlay()
{
	Super::BeginPlay();
...
void AResourceSalvageActor::ApplyMeshVariant()
{
...
void AResourceSalvageActor::ApplyRandomizedScale()
{
