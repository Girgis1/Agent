...
struct FAtomiserStoredResourceEntry
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category="Machine|Atomiser")
	FName ResourceId = NAME_None;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category="Machine|Atomiser", meta=(ClampMin="0"))
...
public:
	...
	UFUNCTION(BlueprintPure, Category="Machine|Atomiser")
	int32 GetTotalStoredScaled() const { return TotalStoredScaled; }
	...
	UFUNCTION(BlueprintPure, Category="Machine|Atomiser")
	void GetStorageSnapshot(TArray<FAtomiserStoredResourceEntry>& OutEntries) const;
